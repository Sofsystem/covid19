...
Vue.component('graph', {
  ...
  methods: {
    ...
    formatDate(date) {
      ...
      return new Date(2000 + (+y), m, d).toISOString().slice(0, 10);
    },
    ...
    updateLayout() {
      ...
      this.layout = {
        ...
        title: 'Trajectory of COVID-19 in Algeria '+ this.selectedData + ' (' + this.dates[this.day -1] + ')',
        showlegend: false,
        xaxis: {
  ...
  created: function() {
    ...
    window.addEventListener('keydown', e => {
      ...
      if ((e.key == ' ') && this.dates.length > 0) {
        ...
        this.paused = true;
        this.day = Math.max(this.day , this.minDay);
      }
...
pullData(selectedData, selectedRegion, updateSelectedCountries = true) {
    ...
    createURL() {
      ...
      if (this.selectedRegion != 'Algeria') {
